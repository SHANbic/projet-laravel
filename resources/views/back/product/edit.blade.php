...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="{{route('product.update', $article->id)}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{method_field('PUT')}}
                <div class="form">
                    ...
                    <div class="form-select">
                        ...
                        <select id="category" name="category_id">
                            ...
                            <option value="{{$id}}" <?php if($article->category_id == $id) echo 'selected'; ?>>{{$title}}</option>
                            @endforeach
                        </select>
                    </div>
